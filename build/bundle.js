	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(UserForm, { className: 'row form', toggleUserModal: this.showUserModal, user: this.state.user })
	          ),
	          _react2.default.createElement(
	            'div',
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { className: 'btn back-btn', onClick: this.props.toggleUserModal },
	          'Back'
	        ),
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { type: 'text', placeholder: 'Email', valueLink: this.linkState('email') }),
	        React.createElement(
	          'label',
	          { 'for': 'bio' },
	          'Bio:'
	        ),
	        React.createElement('textarea', { type: 'text', placeholder: 'bio', valueLink: this.linkState('bio') }),
	        React.createElement(
	          'label',
	          { 'for': 'Interests' },
	          'Interests:'
	        ),
	        React.createElement('input', { type: 'text', placeholder: 'golf, running, dancing, (comma seperated / 5 max)', valueLink: this.linkState('interests') }),
	        React.createElement(
	          'label',
	          { 'for': 'Address' },
	          'Address:'
